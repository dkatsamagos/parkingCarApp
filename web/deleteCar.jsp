...
<html>
    ...
    <body>
        <div class="container">
            ...
            <p>${msg}</p>
            <form action="${pageContext.request.contextPath}/DeleteACarController" method="post">
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-xs-4">
                        ...
                        <input type="text" class="form-control" id="modelName" name="model" value="${car.model}" readonly/><br>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-xs-4">
                        <label for="plateNo" class="font-weight-bold">Plate No.</label>
                        <input type="text" class="form-control" id="plateNo" name="plate" value="${car.plateNumber}" readonly/><br>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-xs-4">
                        <label for="colour" class="font-weight-bold">Color</label>
                        <input type="text"  class="form-control" id="colour" name="color" value="${car.color}" readonly/><br>
                    </div>
                </div>
                <div class="row">
